...
# menu: main
featureImage: "/static/k8s/images/cat.png" # Sets featured image on blog post.
thumbnail: "/static/k8s/images/cat.png" # Sets thumbnail image appearing inside card on homepage.
